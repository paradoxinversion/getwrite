...
- **Project Type**: Declarative file (JSON/YAML) that includes `id`, `name`, `description`, `folders` (ordered), and optional `defaultResources` declarations.
...
- `getwrite-config/templates/project-types` is the authoritative local source for Project Type definitions.
