...
- [ ] T010 [P] [US1] Add integration/mocked test `frontend/tests/create-project-modal.spec.ts` asserting the modal calls `createProjectFromType` and opens a project
